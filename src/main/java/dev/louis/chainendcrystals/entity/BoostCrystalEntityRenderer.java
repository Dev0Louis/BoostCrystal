...
public class BoostCrystalEntityRenderer
extends EntityRenderer<BoostCrystalEntity> {
    private static final Identifier TEXTURE = new Identifier("boostcrystal","textures/entity/boost_crystal.png");
    ...
    public BoostCrystalEntityRenderer(EntityRendererFactory.Context context) {
        super(context);
    ...
    @Override
    public void render(BoostCrystalEntity crystalEntity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        matrixStack.push();
        float h = BoostCrystalEntityRenderer.getYOffset(crystalEntity, g);
        float j = ((float)crystalEntity.endCrystalAge + g) * 3.0f;
    ...
    public static float getYOffset(BoostCrystalEntity crystal, float tickDelta) {
    ...
    @Override
    public Identifier getTexture(BoostCrystalEntity endCrystalEntity) {
        return TEXTURE;
    }

    @Override
    public boolean shouldRender(BoostCrystalEntity endCrystalEntity, Frustum frustum, double d, double e, double f) {
